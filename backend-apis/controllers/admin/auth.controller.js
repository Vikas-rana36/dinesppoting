...
const {forgotPasswordTemplate} = require('../../core/utilities/emailTemplates');
...
exports.login = async (req, res) => {
    ...
    res.header('Access-Control-Expose-Headers', 'CP-auth-token')   
...
exports.updatePassword = async (req, res) => {
    ...
    return apiResponse(res, true, [], '', SUCCESS.OK, 0,[existingUser]) 
}
...
exports.changePassword = async (req, res) => {
    ...
    if(encryptedOldPassword == existingUser.password) return apiResponse(res, true, [], ERROR_MSG['OLD-PASSWORD-NOT-MATCHED'], CLIENT_ERROR.badRequest,0, []); 
